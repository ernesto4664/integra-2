    ...
    public function fields(Request $request)
    {
        ...
        return [
           ...
           // Text::make('Tipo', 'text20')->hideFromIndex(),
            ...
            Boolean::make('¿Registro completo?', 'full_register')
                ->trueValue(1)
                ->falseValue(0)
                ->hideFromIndex(),
                  

            DateTime::make('Fecha de Términos del inicio de la app', 'updated_at_termn_service_home'),


            DateTime::make('Fecha de Términos de la liquidación', 'updated_at_termn_service_liquidacion'),
