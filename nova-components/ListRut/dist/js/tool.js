...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    sendfile: function sendfile() {
      ...
      if (this.myFile.name.split(".").pop() == "xlsx" || this.myFile.name.split(".").pop() == "xlsm" || this.myFile.name.split(".").pop() == "xlsb" || this.myFile.name.split(".").pop() == "xltx" || this.myFile.name.split(".").pop() == "xltm" || this.myFile.name.split(".").pop() == "xlt" || this.myFile.name.split(".").pop() == "xls" || this.myFile.name.split(".").pop() == "xml" || this.myFile.name.split(".").pop() == "xml" || this.myFile.name.split(".").pop() == "xlam" || this.myFile.name.split(".").pop() == "xla" || this.myFile.name.split(".").pop() == "xlw" || this.myFile.name.split(".").pop() == "XLR" || this.myFile.name.split(".").pop() == "csv") {
        var _console;
        var config = {
          headers: {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/nova-vendor/list-rut/send", formData, config).then(function (response) {
          _this.is_loadin = 0;
          _this.errors = "";
          _this.recipients = response.data.data.message;
          _this.heerrorsading = "";
        }, function (error) {
          console.log(error.response);
          _this.is_loadin = 0;
          _this.recipients = "";
          _this.errors = error.response.data.data.message;
        });
      } else {
    ...
    getUserRut: function getUserRut() {
      var _this2 = this;
      this.isLoading = true;
      Nova.request().get("/nova-vendor/list-rut/getUserRut").then(function (data) {
        return data.data.data;
      }).then(function (userRutLists) {
        _this2.userRutLists = userRutLists;
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_heading, {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Listado de usuarios")];
    }),
    _: 1 /* STABLE */
  }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" El formato del archivo debe ser excel o csv. Descargar ejemplo "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    href: this.url + 'Ruts_para_encuesta.xlsx'
  }, " Aquí ", 8 /* PROPS */, _hoisted_2)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Card, {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
        style: {
          "text-align": "center",
          "margin-top": "20px",
          "color": "green"
        }
      }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.recipients), 513 /* TEXT, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, _ctx.recipients]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
        style: {
          "text-align": "center",
          "margin-top": "20px",
          "color": "red"
        }
      }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.errors), 513 /* TEXT, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, _ctx.errors]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [_hoisted_4, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
        "onUpdate:modelValue": _cache[0] || (_cache[0] = function ($event) {
          return _ctx.name = $event;
        }),
        id: "name",
        "class": "w-full form-control form-input form-input-bordered"
      }, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.userRutLists, function (userRutList) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
          key: userRutList.id,
          value: userRutList.id
        }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(userRutList.name), 9 /* TEXT, PROPS */, _hoisted_6);
      }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, _ctx.name]])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [_hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
        type: "file",
        id: "attachment",
        onChange: _cache[1] || (_cache[1] = function ($event) {
          return $options.processFile($event);
        })
      }, null, 32 /* HYDRATE_EVENTS */)])])]), _hoisted_10, _hoisted_11, _hoisted_12, _hoisted_13, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_14, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        disabled: _ctx.is_loadin,
        ...
        onClick: _cache[2] || (_cache[2] = function () {
          return $options.sendfile && $options.sendfile.apply($options, arguments);
        })
      }, " Enviar ", 8 /* PROPS */, _hoisted_15)])];
    }),
    _: 1 /* STABLE */
  })], 512 /* NEED_PATCH */);
}
...
Nova.booting(function (app, store) {
  Nova.inertia('ListRut', _pages_Tool__WEBPACK_IMPORTED_MODULE_0__["default"]);
});
...
/* harmony import */ var C_xampp_htdocs_meet_integra_api_nova_components_ListRut_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmeat_list_rut"] = self["webpackChunkmeat_list_rut"] || [];
